                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr class="table-row" data-href="{{ route('admin.order', [$order[0]['id']]) }}">
                                    <th scope="row">#{{ $order[0]['id'] }}</th>
                                    <td>@php
                                        echo date_format($order[0]['created_at'], 'd M');
                                        echo ' at ';
                                    ...
                                    <td class="text-center">
                                        @if ($order[0]['payment_status'] == 'Paid')
                                            <div class="block1"><i
                                                    class="fas fa-circle"></i>{{ $order[0]['payment_status'] }}</div>
                                        @else
                                            <div class="block2"><i
                                                    class="far fa-circle"></i>{{ $order[0]['payment_status'] }}</div>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        @if ($order[0]['order_status'] == 'Fulfilled')
                                            <div class="block1 mr-0"><i
                                                    class="fas fa-circle"></i>{{ $order[0]['order_status'] }}</div>
                                        @elseif($order[0]['order_status'] == 'Shipped')
                                            <div class="block3 mr-0"><i
                                                    class="far fa-circle"></i>{{ $order[0]['order_status'] }}</div>
                                    ...
                                    @php
                                        ...
                                        for ($i = 0; $i < count($order); $i++) {
                                            $noOfItems += $order[$i]['orders_items']['product_quantity'];
                                        }
                                    @endphp
                                    <td class="text-center">{{ $noOfItems }}</td>
                                    <td>{{ $order[0]['customer_shipping'][0]['name'] ?? '' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div class="tab-pane fade" id="open" role="tabpanel" aria-labelledby="pills-open-tab">
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                @if (
                                    $order[0]['order_status'] == 'Reviewed' ||
                                        $order[0]['order_status'] == 'Partial Shipped' ||
                                        $order[0]['order_status'] == 'Shipped')
