...
@section('content')
    <div class="row">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="container info-cont">
                        ...
                        <p class="mb-0">
                            @if (@$todayOrders[0]['noOfOrders'] > 0)
                                {{ @$todayOrders[0]['noOfOrders'] }} orders
                            @else
                                No orders yet
                            @endif
                        </p>
                ...
                <div class="col-6">
                    <div class="container info-cont">
                        ...
                        <div class="info-cont-divider"></div>
                        <p class="mb-0">
                            @if (@$todayCheckouts[0]['noOfCheckouts'] > 0)
                                {{ @$todayCheckouts[0]['noOfCheckouts'] }} orders
                            @else
                                No checkout yet
                            @endif
                        </p>
        ...
        <div class="col-4 home-right">
            ...
            <p class="mb-0">
                @if (@$orders[0]['noOfOrders'] > 0)
                    {{ @$orders[0]['noOfOrders'] }} orders
                @else
                    No orders yet
                @endif
            </p>
            ...
            <p class="mb-0">
                @if (@$checkouts[0]['noOfCheckouts'] > 0)
                    {{ @$checkouts[0]['noOfCheckouts'] }} checkouts
                @else
                    No abandoned checkout yet
                @endif
            </p>
