                                                ...
                                                @else
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        <a id="navbarDropdown" class="nav-link dropdown-toggle"
                                                            ...
                                                            <img style="width:28px;height:auto;margin-right:5px;border-radius:50%;"
                                                                src="{{ $pic }}" />{{ Auth::user()->name }} <span
                                                                class="caret"></span>
                                                        </a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2 admin-menu-cont">
                            ...
                            <a href="/admin/customers" class="admin-menu customers"><i
                                    class="fas fa-user"></i>Customers</a>
                            ...
                            <div class="collapse" id="storeCollapse">
                                <a href="/admin/homepage/announcement"
                                    class="admin-menu1 announcement">Announcement</a>
                                <a href="/admin/homepage/slider" class="admin-menu1 slider">Image slider</a>
                                <a href="/admin/homepage/image-with-text-overlay"
                                    class="admin-menu1 imageWithText">Image
                                    with text</a>
                                <a href="/admin/homepage/services" class="admin-menu1 services">Image with text 2</a>
                            </div>

                            <a href="/admin/settings" class="admin-menu settings"><i
