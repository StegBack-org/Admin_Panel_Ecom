...
@section('content')
    <div class="container">
        <div class="container mb-4">
            <div class="row">
                <div class="col-md-1">
                    <button class="btn btn-secondary" onclick="window.location.href='/admin/settings/shipping'"><i
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">Shipping Provider</th>
                            ...
                            <tbody>
                                @foreach ($shippings as $shipping)
                                    <tr class="table-row1">
                                        ...
                                        <th class="align-middle text-center">{{ $shipping['shipping_provider'] }}</th>
                                        ...
                                        <th class="align-middle text-center">
                                            @if ($shipping['min_order_value'] == 0)
                                                Below USD {{ $shipping['max_order_value'] }}
                                            @elseif($shipping['max_order_value'] == 0)
                                                Above USD {{ $shipping['min_order_value'] }}
                                            @else
                                                USD {{ $shipping['min_order_value'] }} - USD
                                                {{ $shipping['max_order_value'] }}
                                            @endif
                                        </th>
                                        <th>
                    ...
                    <form class="needs-validation" action="/admin/settings/shipping/update" method="POST" novalidate>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="validationCustom104" name="cost"
                                    required />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom105">Min. order value</label>
                                <input type="number" class="form-control" id="validationCustom105"
                                    name="min_order_value" required />
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom106">Max. order value</label>
                                <input type="number" class="form-control" id="validationCustom106"
                                    name="max_order_value" required />
                            </div>
                        </div>
                        <p class="text-right"><button type="submit" class="btn btn-primary">Save</button></p>
